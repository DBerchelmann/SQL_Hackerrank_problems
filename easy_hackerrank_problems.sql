...
# Query the sum of Northern Latitudes (LAT_N) from STATION having values greater than 37.7880  and less than 137.2345 . Truncate your answer to  decimal places.
...
# Manhattan formula is (a-c) m+ (b-d)

SELECT ABS(ROUND((MIN(LAT_N) - MAX(LAT_N)),4) + ROUND((MIN(LONG_W) - MAX(LONG_W)),4)) 
FROM station;